...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'div_content.utils.context_processors.get_user_unread_messages',
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'heslo@div.cz'
EMAIL_HOST_PASSWORD = 'Heslo_eKultura_DIV_01'
DEFAULT_FROM_EMAIL = 'heslo@div.cz'
