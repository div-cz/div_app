    ...
    $.extend($.summernote.plugins, {
        'emoji': function (context) {
            ...
            var createdEmojiIcon = function(emoji) {
                ...
                var column = emoji[2];
                var name = emoji[3];
                var filename = document.emojiSource + '/emoji_spritesheet_' + category + '.png';
                var blankGifPath = document.emojiSource + '/tam-emoji/img/blank.gif';
                var iconSize = 25;
                ...
                console.log('Creating emoji:', {name, filename, xoffset, yoffset, scaledWidth, scaledHeight});
                ...
                return '<img src="' + blankGifPath + '" class="img" style="' + style + '" alt="' + Config.htmlEntities(name) + '">';
            };
